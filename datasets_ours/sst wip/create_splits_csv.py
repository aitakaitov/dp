...
def main():
    ...
    dump_to_csv(phrase_sentiments, dataset_sentences_dict[1], 'train.csv')
    dump_to_csv(phrase_sentiments, dataset_sentences_dict[2], 'test.csv')
    dump_to_csv(phrase_sentiments, dataset_sentences_dict[3], 'dev.csv')
